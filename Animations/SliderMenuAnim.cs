...
public class SliderMenuAnim : MonoBehaviour
{
	...
	void Start()
	{
		maxTab = PlayerData.player.GetRecipeTable().Count-1;
	...
	private void RefreshPage(int pageNum)
	{
		...
		FoodObject food = PlayerData.player.GetRecipeTable()[currentTab][currentPage-1];
	...
	{
		maxPage = PlayerData.player.GetRecipeTable()[currentTab].Count;
	}
